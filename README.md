...
<div style="display: flex; gap: 50px; justify-content: center; max-width: 1200px; margin: 0 auto; padding: 10px; flex-wrap: wrap;">
    <a href="#" style="flex: 1; min-width: 300px; aspect-ratio: 1.6; display: flex;">
